...
export const fetchBioData = async () => {
  try {
    ...
    console.warn("Supabase bio fetch failed, using local fallback.");
...
export const fetchSkillsData = async () => {
  try {
    ...
    console.warn("Supabase skills fetch failed, using local fallback.");
...
export const fetchSkillsWithCategories = async () => {
  try {
    ...
    console.warn("Supabase categorized skills fetch failed, using local fallback.");
...
export const fetchProjects = async () => {
  try {
    ...
    console.warn("Supabase projects fetch failed, using local fallback.");
...
export const fetchExperiences = async () => {
  try {
    ...
    console.warn("Supabase experiences fetch failed, using local fallback.");
...
export const fetchEducation = async () => {
  try {
    ...
    console.warn("Supabase education fetch failed, using local fallback.");
