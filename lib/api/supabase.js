...
export const fetchBioData = async () => {
  try {
    ...
    console.error("Error fetching bio data, trying local:", error);
...
export const fetchSkillsData = async () => {
  try {
    ...
    console.error("Error fetching skills data, trying local:", error);
...
export const fetchSkillsWithCategories = async () => {
  try {
    ...
    console.error("Error fetching skills with categories, trying local:", error);
...
export const fetchProjects = async () => {
  try {
    ...
    console.error("Error fetching projects data, trying local:", error);
...
export const fetchExperiences = async () => {
  try {
    ...
    console.error("Error fetching experiences data, trying local:", error);
...
export const fetchEducation = async () => {
  try {
    ...
    console.error("Error fetching education data, trying local:", error);
